...
function validateJson(jsonToValidate: { ascents?: Record<string, unknown>[]; totalItems?: number }, isRaw?: boolean) {
  if (jsonToValidate && jsonToValidate.ascents && jsonToValidate.ascents.length && jsonToValidate.totalItems) {
      ...
      <div class="blk-container">
        ...
        <div class="bg1">
          ...
          <p style="text-align: left">
            Select a local JSON file of ascents from 8a.nu to view the analytics of a climber not in the
            sandbox. Get it by using the following url <strong>when logged into</strong> 8a.nu. If you
            click the below link it will take you to my ascent response. Simply change the section marked
            "user-name" to the kebab username of the user you want to analyze.
          </p>
          ...
          <p style="text-align: left">
            After using the above URL you should see a ton of text in the broswer. Right click anywhere and
            then click "Save as.." and save it somewhere on your computer (I did not figure out how to do
            this on my phone). Remember where you saved it then click the "Choose File" button below and
            find it. It looks specifically for ".json" files so make sure you save the file with a ".json"
            extension
          </p>
          ...
          <p style="text-align: left">
            Or alternatively copy paste the JSON response text into the below. This is possible on a phone,
            but you have to figure out how to select all on your device.
          </p>
          <div class="import-btn">
            <textarea
              ref="rawJson"
